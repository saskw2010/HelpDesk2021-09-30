...
{
    public partial class IHelpDeskTicketmasterdetailsperuserComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Grid0LoadData(LoadDataArgs args)
        {
            try
            {
                var authenticationconnGetHelpDeskTicketsResult = await Authenticationconn.GetHelpDeskTickets(filter:$@"TicketRequesterUser eq ""{Security.User.Name}""", orderby:$@"{args.OrderBy}", expand:$"HelpDeskStatus,LocationList,ServiceCatglist,ServicesList", top:args.Top, skip:args.Skip, count:args.Top != null && args.Skip != null);
