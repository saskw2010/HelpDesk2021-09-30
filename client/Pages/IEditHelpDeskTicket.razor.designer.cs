...
{
    public partial class IEditHelpDeskTicketComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var authenticationconnGetHelpDeskTicketDetailsResult = await Authenticationconn.GetHelpDeskTicketDetails(filter:$@"HelpDeskTicketId eq {Id}", orderby:$@"TicketDetailDate desc");
            if (Id != null) {
        ...
        {
            UriHelper.NavigateTo("help-desk-tickets");
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Testauth.Models.Authenticationconn.HelpDeskTicket args)
        {
            try
            {
                ...
                {
                    await GlobalsService.SaveTicket(args.TicketRequesterEmail,args.TicketGUID);
                }
