...
{
    public partial class EditHelpDeskTicketDetailComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var authenticationconnGetHelpDeskTicketDetailByIdResult = await Authenticationconn.GetHelpDeskTicketDetailById(id:Convert.ChangeType(Id, Type.GetTypeCode(typeof(Int64))));
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Testauth.Models.Authenticationconn.HelpDeskTicketDetail args)
        {
            try
            {
                var authenticationconnUpdateHelpDeskTicketDetailResult = await Authenticationconn.UpdateHelpDeskTicketDetail(id:Convert.ChangeType(Id, Type.GetTypeCode(typeof(Int64))), helpDeskTicketDetail:helpdeskticketdetail);
